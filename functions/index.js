/**
 * CryptoAuto - Mobile-First Worker
 */
...
<head>
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .form-group { margin-bottom: 15px; }
    .form-group label { display: block; margin-bottom: 6px; font-size: 13px; font-weight: 600; }
    .form-group input { width: 100%; padding: 10px; background: rgba(255, 255, 255, 0.05); border: 1px solid rgba(255, 255, 255, 0.1); border-radius: 6px; color: white; font-size: 14px; }
    .btn-primary { width: 100%; padding: 12px; background: #10b981; color: white; border: none; border-radius: 6px; font-weight: 600; cursor: pointer; font-size: 14px; margin-top: 10px; }
    ...
    @media (min-width: 768px) {
      ...
      .bottom-nav { height: auto; padding: 15px; }
      .nav-item { padding: 15px; font-size: 14px; }
    }
  </style>
</head>
<body>
...
<div class="dashboard" id="dashboard">
  ...
  <div class="content">
    ...
    <div class="section" id="trades">
      <h2>💹 Trade History</h2>
      <div class="card">
        <p>View all your completed trades and performance analytics.</p>
      </div>
    </div>
...
<head>
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    nav { display: flex; justify-content: space-between; align-items: center; margin-bottom: 40px; padding: 15px 0; border-bottom: 1px solid rgba(255,255,255,0.1); }
    ...
    .pricing-card .badge { background: #10b981; color: #0f172a; padding: 6px 12px; border-radius: 20px; font-size: 11px; font-weight: 600; margin-bottom: 15px; display: inline-block; }
    .plan-name { font-size: 18px; font-weight: 700; margin-bottom: 10px; }
    .price { font-size: 32px; font-weight: 700; margin-bottom: 5px; }
    .price-period { font-size: 13px; color: rgba(255,255,255,0.6); margin-bottom: 15px; }
    .btn { display: block; width: 100%; padding: 12px; background: #10b981; color: white; border: none; border-radius: 6px; font-weight: 600; cursor: pointer; font-size: 14px; margin-bottom: 20px; }
    .btn:active { background: #059669; }
    .features { list-style: none; text-align: left; font-size: 13px; }
    .features li { padding: 8px 0; border-bottom: 1px solid rgba(255,255,255,0.1); color: rgba(255,255,255,0.8); }
  ...
  <div class="container">
    ...
    <div class="pricing-grid">
      <div class="pricing-card">
        ...
        <button class="btn" onclick="alert('Start free trial')">Get Started</button>
        <ul class="features">
          <li>Full access</li>
          <li>1 active bot</li>
          <li>Binance only</li>
      ...
      <div class="pricing-card popular">
        ...
        <button class="btn" onclick="alert('Stripe checkout: price_1TtWCFLOZXS86s51skj0JXNA')">Upgrade to Pro</button>
        <ul class="features">
      ...
      <div class="pricing-card">
        ...
        <div class="price-period">per month</div>
        <button class="btn" onclick="alert('Stripe checkout: price_1TtWF1LOZXS86s51BJWXy9Pq')">Contact Sales</button>
        <ul class="features">
...
<body>
  <div class="container">
    ...
    <div class="hero">
      ...
      <button class="cta" onclick="window.location.href='/pricing'">See Pricing</button>
    </div>
    <div class="features">
      <div class="feature"><div class="feature-icon">🤖</div><h3>AI-Powered</h3><p>Trading signals 24/7</p></div>
      <div class="feature"><div class="feature-icon">🛡️</div><h3>Your Control</h3><p>Keep your API keys</p></div>
